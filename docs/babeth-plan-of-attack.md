...
1. **1Password:** Setup **1Password** as her password manager
    1. **PC:** Desktop App + Chrome Extension
        1. **Download Link:** [1Password for Windows](https://c.1password.com/dist/1P/win8/1PasswordSetup-latest.msixbundle)
        2. Set **1Password** as default Password Manager and disable saving passwords, identity, personal details, and cards elsewhere (Google)
    2. **iOS:** App, Safari Extension, Chrome Extension
        1. **Download Link:** [1Password for iOS](https://apps.apple.com/us/app/1password-password-manager/id1511601750)
        2. Set **1Password** as default Password Manager and disable saving passwords, identity, personal details, and cards elsewhere (KeyChain + Google)
    3. Verify where her passwords, identity, personal details, and cards are currently stored:
        1. Safari/iOS Keychain
            - Search `AutoFill`
        2. Chrome/Google Passwords
...
2. **AdGuard** on all devices (optional VPN using my Mullvad OpenGuard configuration)
    1. **PC**
        1. **AdGuard Desktop:**
            1. **Download Link:** [AdGuard AdBlocker for Windows](https://static.adtidy.org/windows/beta/setup.exe)
        2. **Browser Assistant:**
            1. **Download Link:** [AdGuard Browser Assistant for Google Chrome](https://chromewebstore.google.com/detail/adguard-browser-assistant/fbohpolgemkbfphodcfgnpjcmedcjhpn)
    2. **iOS**
        1. **Download Link:** [AdGuard AdBlocker for iOS/Safari](https://apps.apple.com/us/app/adguard-ad-blocker-for-safari/id1047223162)
...
4. **(Optional) Mullvad**
    1. **PC:**
        1. **Download Link:** [Mullvad VPN for Windows](https://releases.mullvad.net/desktop/installer-downloader/1.2.0/Install%20Mullvad%20VPN.exe)
    2. **iOS:**
        1. **Download Link:** [Mullvad VPN for iOS](https://apps.apple.com/us/app/mullvad-vpn/id1488466513)
